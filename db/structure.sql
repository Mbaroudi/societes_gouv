...
CREATE INDEX entreprises_to_tsvector_idx ON entreprises USING gin (to_tsvector('french'::regconfig, (siren)::text));
...
CREATE INDEX entreprises_to_tsvector_idx1 ON entreprises USING gin (to_tsvector('french'::regconfig, (siret)::text));
...
CREATE INDEX entreprises_to_tsvector_idx2 ON entreprises USING gin (to_tsvector('french'::regconfig, (nom_raison_sociale)::text));


--
-- Name: index_entreprises_on_nom_raison_sociale; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_entreprises_on_nom_raison_sociale ON entreprises USING btree (nom_raison_sociale);


--
-- Name: index_entreprises_on_siren; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_entreprises_on_siren ON entreprises USING btree (siren);


--
-- Name: index_entreprises_on_siret; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_entreprises_on_siret ON entreprises USING btree (siret);
